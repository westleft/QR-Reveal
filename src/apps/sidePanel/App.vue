...
const { clearAllStorage, clearStorage, historyData } = useChromeStorage()
...
<template>
  <div id="qr-side-panel">
    <div class="panel-title">
      ...
      <button @click="clearAllStorage">
        {{ getMessage('side_panel_clear_all_history') }}
      </button>
    </div>
    <TransitionGroup name="list" tag="ul" class="panel-list">
      <li v-for="(item, key) in historyData" :key="key" class="panel-list__item">
        <a v-if="item.type === 'website'" class="link-wrapper" target="_blank" href="https://www.google.com">
          ...
          <div class="link-actions">
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 640"
              @click.stop.prevent="clearStorage(key)"
    ...
    <div v-if="historyData.length === 0" class="panel-list-empty">
      <img src="@/assets/images/icon.png" alt="logo">
      <p>No Scan History</p>
    </div>
  </div>
